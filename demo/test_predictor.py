...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='/home/kartik/Documents/personal/git-repos/mmfashion/demo/imgs/attr_pred_demo1.jpg')
    parser.add_argument(
        '--checkpoint',
        type=str,
        help='checkpoint file',
        default='/home/kartik/Documents/personal/git-repos/mmfashion/checkpoints/attr_predic_global_pooling_vgg16.pth')
    parser.add_argument(
        '--config',
        help='test config file path',
        default='/home/kartik/Documents/personal/git-repos/mmfashion/configs/attribute_predict/global_predictor_vgg_attr.py')
    parser.add_argument(
